...
<style scoped>
  ...
  .keypoint-cont p.type {
    height: 42px;
    padding-left: 0;
    padding-right: 0;
  }

  .keypoint-cont p.type > span {
    display: flex;
    align-items: flex-end;
    line-height: 32px;
  }

  .keypoint-cont p.type > span .icon {
    font-size: 32px;
    color: #3182FF;
  }

  .keypoint-cont p.type > span .label {
    padding-left: 8px;
    padding-right: 8px;
    font-weight: bold;
    font-size: 18px;
  ...
  .keypoint-cont p.type > span .tips {
    display: flex;
  ...
  .keypoint-cont p.type > span .tips-icon {
    width: 18px;
    height: 18px;
    font-weight: bold;
    font-size: 12px;
  ...
  .keypoint-cont p.type > span .tips-text {
    display: none;
    position: absolute;
    top: -32px;
    height: 24px;
  ...
  .keypoint-cont p.type > span .tips-text:before {
    content: "";
    position: absolute;
    bottom: -6px;
    left: 50%;
    ...
    border-style: solid;
    border-color: #3182FF transparent transparent transparent;
  }

  .keypoint-cont p.type > span .tips-icon:hover + .tips-text {
    display: block;
  }

  .keypoint-cont p.type select {
    height: 24px;
    padding-right: 20px;
    color: #3182FF;
    font-size: 16px;
  ...
  .keypoint-cont p.type select option {
    font-size: 14px;
  }

  .keypoint-cont p.newest {
  ...
  .keypoint-cont p.newest strong {
    font-weight: bold;
    font-size: 18px;
  }

  .keypoint-cont p.newest small {
    padding-left: 6px;
    font-size: 12px;
  }

  .keypoint-cont p.up strong,
  .keypoint-cont p.up small {
    color: #23CD09;
  }

  .keypoint-cont p.down strong,
  .keypoint-cont p.down small {
    color: #F34246;
  }

  .keypoint-cont p.low,
  .keypoint-cont p.high {
    height: 24px;
  }

  .keypoint-cont p.low span,
  .keypoint-cont p.high span {
    font-size: 14px;
    color: #fff;
    margin-top: 15px;
  }
