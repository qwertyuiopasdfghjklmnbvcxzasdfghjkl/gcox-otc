...
<style scoped>
  ...
  .undone-center-buys p {
    width: 46px;
  }

  .undone-center-number p {
    color: #666;
    font-size: 12px;
    line-height: 24px;
    width: 140px;
  ...
  .undone-right a:hover {
    background-color: #2565c5;
  }

  .undone-right a.disabled {
    color: #999;
    background-color: #ccc;
    cursor: not-allowed;
  }

  .undone-center-type select {
    color: #666;
    width: 100px;
  }

  .undone-center-type select[disabled] {
